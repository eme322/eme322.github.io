      ...
      <div className="tsm-section-wrap alt">
        <div className="tsm-section">
          ...
          <div className="tsm-skills">
            {data.skills.map(({ name, pct }, i) => (
              <div className="tsm-skill" key={i}>
      ...
      <div className="tsm-section-wrap">
        <div className="tsm-section">
          ...
          <div className="tsm-projects">
            {data.projects.map(({ emoji, bg, title, desc }, i) => (
              <div className="tsm-project-card" key={i}>
      ...
      <div className="tsm-section-wrap alt">
        <div className="tsm-section">
          ...
          <div className="tsm-interests">
            {data.interests.map(({ emoji, label }, i) => (
              <div className="tsm-interest" key={i}>
      ...
      <div className="tsm-section-wrap">
        <div className="tsm-section">
          ...
          <div className="tsm-contacts">
            {data.contact.map(({ icon, label, value }, i) => (
              <div className="tsm-contact-item" key={i}>
